...
/**
 * @title ConfigureL2Testnet
 * @notice Post-deploy configuration for L2 testnets (Base Sepolia, Arbitrum Sepolia):
 *         - Sets BASE_FEE to 2% (vs 70% mainnet) to stretch testnet ETH
 *         - Keeps 50/50 protocol/controller split to demo the fee mechanic
 *
 * Usage:
 *   PRIVATE_KEY=0x... AUTO_LOOP=0x... forge script script/ConfigureL2Testnet.s.sol \
 *     --rpc-url $BASE_SEPOLIA_RPC_URL --broadcast
 */
contract ConfigureL2Testnet is Script {
