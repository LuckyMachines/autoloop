...
contract DeployGames is Script {
    function run() external {
        ...
        registrar.registerAutoLoopFor{value: fundAmount}(address(crumbleCore), maxGas);
        ...
        registrar.registerAutoLoopFor{value: fundAmount}(address(gladiatorArena), maxGas);
        ...
        registrar.registerAutoLoopFor{value: fundAmount}(address(mechBrawl), maxGas);
        ...
        registrar.registerAutoLoopFor{value: fundAmount}(address(sorcererDuel), maxGas);
        ...
        registrar.registerAutoLoopFor{value: fundAmount}(address(kaijuLeague), maxGas);
        ...
        registrar.registerAutoLoopFor{value: fundAmount}(address(voidHarvester), maxGas);
        ...
        registrar.registerAutoLoopFor{value: fundAmount}(address(sponsorAuction), maxGas);
        ...
        registrar.registerAutoLoopFor{value: fundAmount}(address(gladiatorOracle), maxGas);
        ...
        registrar.registerAutoLoopFor{value: fundAmount}(address(oracleRun), maxGas);
        ...
        registrar.registerAutoLoopFor{value: fundAmount}(address(kaijuOracle), maxGas);
        ...
        registrar.registerAutoLoopFor{value: fundAmount}(address(forecasterLeaderboard), maxGas);
